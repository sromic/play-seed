...
trait DBTableDefinitions {
  ...
  class Users(tag: Tag) extends Table[DBUser](tag, "user") {
    ...
    def * =
      (id, firstName, lastName, fullName, email, avatarURL) <> (DBUser.tupled, DBUser.unapply)
  }
  ...
  case class DBOpenIDInfo(id: String, loginInfoId: Long)
  ...
  case class DBOpenIDAttribute(id: String, key: String, value: String)
